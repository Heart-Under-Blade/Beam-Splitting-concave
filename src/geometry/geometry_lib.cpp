...
void Geometry::DifferPolygons(const Polygon1 &subject, const Vector3f &subjNormal,
...
bool Geometry::IncidentBeamToFacet(Facet *facet, const Polygon1 &beamPol,
...
bool Geometry::ProjectPolygonToPlane(const Polygon1 &polygon, const Vector3f &dir,
